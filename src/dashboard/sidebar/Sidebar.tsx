...
const style = {
  ...
  open: "absolute duration-500 ease-in transition-all w-8/12 z-30 sm:w-5/12 md:w-64",
  default:
    "h-screen overflow-y-auto text-white top-0 lg:absolute bg-gray-900 lg:block",
};
